...
const PEOPLE = [
  ...
  },
  {
    ...
    indicadoPor: "Lula",
    vote: "vista",
    tag: "Pediu vista — voto fora do placar",
...
const CATEGORY_META = {
  master:  { label: "Caso Master",      color: "#c17817" },
  stf:     { label: "Ministros / STF",  color: "#2d5f8a" },
  pf:      { label: "Polícia Federal",  color: "#2f7a63" },
  bozo:    { label: "Família Bolsonaro",color: "#a13d4c" },
};

/* Legenda de quem indicou cada ministro */
const INDICACAO_META = {
  "Bolsonaro":        { color: "#3f7d4f" },
  "Temer":            { color: "#b8860b" },
  "Lula":              { color: "#b3402f" },
  "Lula (1º mandato)": { color: "#b3402f" },
  "Dilma":            { color: "#7c5cbf" },
  "FHC":              { color: "#2d6ca8" },
};

const VOTE_META = {
  separar:   { label: "Manter separados", color: "#2d6ca8" },
  unificar:  { label: "Unificar",         color: "#c17817" },
  vista:     { label: "Pediu vista",      color: "#6b6b6b" },
  ausente:   { label: "Não votou",        color: "#999999" },
};
